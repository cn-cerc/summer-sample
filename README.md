...
| -------- | :--------: | ----------- | -------- | -------- | -------- |
| 2747     | AB      | AB180701001 | 2018-7-1 | 自己姓名 | 当前时间 |
| 2747     | AB       | AB180701002 | 2018-7-1 | 自己姓名 | 当前时间 |
| 2747     | BC       | BC180701001 | 2018-7-1 | 自己姓名 | 当前时间 |
| 2747     | BC       | BC180701004 | 2018-7-1 | 自己姓名 | 当前时间 |
| 2747     | AE       | AE180701001 | 2018-7-1 | 自己姓名 | 当前时间 |
| 2747     | AE       | AE180701002 | 2018-7-1 | 自己姓名 | 当前时间 |

##### 3-1-2 单身数据

| 帐套代码 | 单据编号    | 单序 | 商品编号 | 名称 | 规格 | 单位 | 数量 |
| -------- | ----------- | ---- | -------- | ---- | ---- | ---- | ---- |
| 2325     | AB180701001 | 1    | P001     | 电脑 | I5   | 台   | 2    |
| 2325     | AB180701001 | 2    | P002     | 电脑 | I7   | 台   | 3    |
| 2325     | AB180701001 | 3    | P003     | 手机 | 华为 | 部   | 1    |
| 2325     | AB180701001 | 4    | P004     | 手机 | 三星 | 部   | 2    |
...
2、要能通过明细数据计算并且得到汇总页面的数据

3、能够查询指定日期和指定单据的数据明细
