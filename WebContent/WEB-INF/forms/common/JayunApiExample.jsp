...
<body>
    ...
    <ul>
        <li>新用户注册时，发送验证码
            <form method="post" action="JayunApiExample.requestRegister">
                注册手机号码：<input name="mobile" value="${mobile}" /> <br /> <input
                    type="submit" value="sumbit" />
            </form>
        </li>
        <li>检查新用户收到的验证码
            <form method="post" action="JayunApiExample.checkRegister">
        ...
        <li>注册用户的密保手机
            <form method="post" action="JayunApiExample.userRegister">
        ...
        <li>检查环境是否安全
            <form method="post" action="JayunApiExample.isSecurity">
        ...
        <li>在检查到环境不安全时，请求发送验证码
            <form method="post" action="JayunApiExample.requestVerify">
                用户帐号：<input name="user" value="${user}" /> 用户设备Id：<input
                    name="deviceId" value="${deviceId}" /><br /> <input type="submit"
                    value="sumbit" />
            </form>
        ...
        <li>检查收到的验证码是否正确
            <form method="post" action="JayunApiExample.checkVerify">
                用户帐号：<input name="user" value="${user}" /> 用户设备Id：<input
        ...
        <li>检查当前环境是否安全（整合使用）
            <form method="post" action="JayunApiExample.check">
                用户帐号：<input name="user" value="${user}" /> 用户设备Id：<input
